...
const AllCategoryProducts = () => {
    return (
        <div className='grid lg:grid-cols-3  md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-5 my-5 font-normal'>
            <div className='h-[350px] bg-white border border-[#F4F4F6] p-2 rounded-md mb-4'>
                <div className='bg-[#F4F4F6] rounded-md relative'>
                    ...
                    <div className=' mb[-100px]'>
                        <AiOutlineHeart className='absolute xl:ml-[220px] lg:ml-[140px] sm:ml-[180px] ml-[160px] mt-[-185px] text-gray-400 md:ml-[140px]' />
                    </div>
                </div>
                <div className='mt-2'>
                    <div>
                    ...
                    <div className='flex justify-between text-[#227ED2] font-medium mt-4'>
                        <p>৳10500</p>
                        <p><BsBasket /></p>
                    </div>
                </div>
            ...
            <div className='h-[350px] bg-white border border-[#F4F4F6] p-2 rounded-md mb-4'>
                <div className='bg-[#F4F4F6] rounded-md relative'>
                    <img className='w-[150px] h-[200px] mx-auto pt-4' src={pro10} alt="" />
                    <div className=' mb[-100px]'>
                        <AiOutlineHeart className='absolute lg:ml-[220px] ml-[200px] mt-[-180px] text-gray-400 md:ml-[140px]' />
                    </div>
                </div>
                <div className='mt-2'>
                    <div>
