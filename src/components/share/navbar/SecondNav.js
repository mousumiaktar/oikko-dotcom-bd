...
const SecondNav = () => {
    ...
    return (
        <>
            <div className='flex items-center  max-w-[1240px] mx-auto px-4'>
                <div className='hidden md:flex gap-10 ml-12'>
                    <NavLink className="font-medium text-sm">Women's Fashion</NavLink>
                    <NavLink className="font-medium text-sm">men's Fashion</NavLink>
                    <NavLink className="font-medium text-sm">Kid's Fashion</NavLink>
                    <NavLink className="font-medium text-sm">Home & Lifestyle</NavLink>
                ...
                <ul className={nav ? 'fixed right-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'ease-in-out duration-500 fixed right-[100%]'}>
